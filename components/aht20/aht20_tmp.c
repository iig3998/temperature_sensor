...
#define TAG_AHT_20 "AHT20"

/**/
static bool getbit(int NUM, int n) {
...
static void check_calibration() {
    ...
    ESP_LOGI(TAG_AHT_20, "Status %u\n", (uint8_t)status_byte[0]);

    vTaskDelay(100 / portTICK_PERIOD_MS);
}

static void trigger_measure() {
...
void aht20_read_measures(void *ignore) {
    ...
    while (1) {
        ...
        ESP_LOGI(TAG_AHT_20, "Temperature is %3.2f\n", (float)temp);
        ESP_LOGI(TAG_AHT_20, "Humidity is %3.2f\n", (float)rh);
